...
HD_PWD='C:/AES/AES.runs/aes_bd_aes_encrypt_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_bd_aes_encrypt_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_bd_aes_encrypt_top_0_0.tcl
