...
entity aes_encrypt_hls_sbkb_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_encrypt_hls_sbkb_rom is 
...
entity aes_encrypt_hls_sbkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_encrypt_hls_sbkb is
    component aes_encrypt_hls_sbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_encrypt_hls_sbkb_rom_U :  component aes_encrypt_hls_sbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
