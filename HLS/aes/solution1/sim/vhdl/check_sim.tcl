# ==============================================================
# File generated on Mon Apr 13 21:46:00 -0400 2020
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.aes_encrypt_hls_stream.autotvin_inStream_V_V.dat"
         "c.aes_encrypt_hls_stream.autotvin_outStream_V_V.dat"
         "c.aes_encrypt_hls_stream.autotvin_keyStream_V_V.dat"
         "c.aes_encrypt_hls_stream.autotvout_outStream_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.aes_encrypt_hls_stream.autotvout_outStream_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
