...
if {[file isfile aes_encrypt_hls_stream.autotvin.dat]} {
	file delete -force aes_encrypt_hls_stream.autotvin.dat
}

if {[file isfile aes_encrypt_hls_stream.autotvout.dat]} {
	file delete -force aes_encrypt_hls_stream.autotvout.dat
}
