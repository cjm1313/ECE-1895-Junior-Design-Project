...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aes_encrypt_hls_stream.autotvin.dat"
	set constFileTvOut       "aes_encrypt_hls_stream.autotvout.dat"
	set constFileHdlTvIn     "aes_encrypt_hls_stream.autohdltvin.dat"
	set constFileHdlTvOut    "aes_encrypt_hls_stream.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
