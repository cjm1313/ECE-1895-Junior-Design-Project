// ==============================================================
// File generated on Mon Apr 13 21:45:53 -0400 2020
...
#define AUTOTB_TVIN_inStream_V_V  "../tv/cdatafile/c.aes_encrypt_hls_stream.autotvin_inStream_V_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_V  "../tv/cdatafile/c.aes_encrypt_hls_stream.autotvout_outStream_V_V.dat"
#define AUTOTB_TVIN_outStream_V_V  "../tv/cdatafile/c.aes_encrypt_hls_stream.autotvin_outStream_V_V.dat"
...
// wrapc file define: "keyStream_V_V"
#define AUTOTB_TVIN_keyStream_V_V  "../tv/cdatafile/c.aes_encrypt_hls_stream.autotvin_keyStream_V_V.dat"
#define WRAPC_STREAM_SIZE_IN_keyStream_V_V  "../tv/stream_size/stream_size_in_keyStream_V_V.dat"
#define WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V  "../tv/stream_size/stream_ingress_status_keyStream_V_V.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "outStream_V_V"
#define AUTOTB_TVOUT_PC_outStream_V_V  "../tv/rtldatafile/rtl.aes_encrypt_hls_stream.autotvout_outStream_V_V.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{keyStream_V_V " << keyStream_V_V_depth << "}\n";
...
extern void aes_encrypt_hls_stream (
hls::stream<ap_uint<8> > (&inStream),
hls::stream<ap_uint<8> > (&outStream),
hls::stream<ap_uint<8> > (&keyStream));

void AESL_WRAP_aes_encrypt_hls_stream (
hls::stream<ap_uint<8> > (&inStream),
hls::stream<ap_uint<8> > (&outStream),
hls::stream<ap_uint<8> > (&keyStream))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		// pop stream input: "keyStream"
		aesl_fh.read(WRAPC_STREAM_SIZE_IN_keyStream_V_V, AESL_token); // [[transaction]]
		aesl_fh.read(WRAPC_STREAM_SIZE_IN_keyStream_V_V, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(WRAPC_STREAM_SIZE_IN_keyStream_V_V, AESL_token); // pop_size
			...
			while (AESL_token != "[[/transaction]]")
			{
				...
				while (!no_x)
				{
					...
					if (x_found != string::npos)
					{
						if (!err)
						{
							cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'X' on port 'outStream_V_V', possible cause: There are uninitialized variables in the C design." << endl;
							err = true;
						}
	...
	else
	{
		...
		// "keyStream_V_V"
		char* tvin_keyStream_V_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_keyStream_V_V);
		char* wrapc_stream_size_in_keyStream_V_V = new char[50];
		aesl_fh.touch(WRAPC_STREAM_SIZE_IN_keyStream_V_V);
		char* wrapc_stream_ingress_status_keyStream_V_V = new char[50];
		aesl_fh.touch(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V);
		...
		// dump stream tvin: "keyStream"
		std::vector<ap_uint<8> > aesl_tmp_6;
		int aesl_tmp_7 = 0;
		while (!keyStream.empty())
		{
			aesl_tmp_6.push_back(keyStream.read());
			aesl_tmp_7++;
		}
		...
		// push back input stream: "keyStream"
		for (int i = 0; i < aesl_tmp_7; i++)
		{
			keyStream.write(aesl_tmp_6[i]);
		}

// [call_c_dut] ---------->

		CodeState = CALL_C_DUT;
		aes_encrypt_hls_stream(inStream, outStream, keyStream);
     ...
     aesl_tmp_3.clear();
		...
		// record input size to tv3: "keyStream"
		int aesl_tmp_8 = keyStream.size();
     ...
     if (aesl_tmp_1 > aesl_tmp_2)
     {
		...
		// [[transaction]]
		sprintf(tvin_keyStream_V_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_keyStream_V_V, tvin_keyStream_V_V);
		aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, tvin_keyStream_V_V);

		sc_bv<8>* keyStream_V_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_7 - aesl_tmp_8];

		// RTL Name: keyStream_V_V
		{
			// bitslice(7, 0)
			{
				int hls_map_index = 0;
				// celement: keyStream.V.V(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							sc_lv<8> keyStream_V_V_tmp_mem;
							keyStream_V_V_tmp_mem = (aesl_tmp_6[i_0]).to_string(2).c_str();
							keyStream_V_V_tvin_wrapc_buffer[hls_map_index].range(7, 0) = keyStream_V_V_tmp_mem.range(7, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		{
			sprintf(tvin_keyStream_V_V, "%s\n", (keyStream_V_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_keyStream_V_V, tvin_keyStream_V_V);
		}
     ...
     {
		sc_int<32> stream_ingress_size_keyStream_V_V = aesl_tmp_7;
		aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, stream_ingress_size_keyStream_V_V.to_string().c_str());
		aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, "\n");

		for (int i = 0; i < aesl_tmp_7 - aesl_tmp_8; i++)
		{
			stream_ingress_size_keyStream_V_V--;
			aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, stream_ingress_size_keyStream_V_V.to_string().c_str());
			aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, "\n");
		}
     }
     else {
		    sc_int<32> stream_ingress_size_keyStream_V_V = 0;
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, stream_ingress_size_keyStream_V_V.to_string().c_str());
		    aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, "\n");
     }

		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.keyStream_V_V_depth);
		sprintf(tvin_keyStream_V_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_keyStream_V_V, tvin_keyStream_V_V);
		aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_keyStream_V_V, tvin_keyStream_V_V);

		// release memory allocation
		delete [] keyStream_V_V_tvin_wrapc_buffer;

		// dump stream size
		sprintf(wrapc_stream_size_in_keyStream_V_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(WRAPC_STREAM_SIZE_IN_keyStream_V_V, wrapc_stream_size_in_keyStream_V_V);
		sprintf(wrapc_stream_size_in_keyStream_V_V, "%d\n", aesl_tmp_7 - aesl_tmp_8);
		aesl_fh.write(WRAPC_STREAM_SIZE_IN_keyStream_V_V, wrapc_stream_size_in_keyStream_V_V);
		sprintf(wrapc_stream_size_in_keyStream_V_V, "[[/transaction]] \n");
		aesl_fh.write(WRAPC_STREAM_SIZE_IN_keyStream_V_V, wrapc_stream_size_in_keyStream_V_V);
		...
		// release memory allocation: "keyStream_V_V"
		delete [] tvin_keyStream_V_V;
		delete [] wrapc_stream_size_in_keyStream_V_V;
