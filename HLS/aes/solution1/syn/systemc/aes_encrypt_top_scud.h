...
// ==============================================================
#ifndef __aes_encrypt_top_scud_H__
#define __aes_encrypt_top_scud_H__
...
struct aes_encrypt_top_scud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(aes_encrypt_top_scud_ram) {
        ram[0] = "0b01111100";
        ram[1] = "0b01111011";
        ram[2] = "0b01101011";
        ram[3] = "0b11000101";
...
SC_MODULE(aes_encrypt_top_scud) {
...
aes_encrypt_top_scud_ram* meminst;


SC_CTOR(aes_encrypt_top_scud) {
meminst = new aes_encrypt_top_scud_ram("aes_encrypt_top_scud_ram");
